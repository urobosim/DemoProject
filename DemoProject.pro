...
DemoProjectRootPath=/home/michael/work/development/DemoProject
...
include(DemoProjectSource.pri)
include(DemoProjectHeader.pri)
include(DemoProjectConfig.pri)
include(DemoProjectIncludes.pri)
include(DemoProjectDefines.pri)
...
DemoProject-Linux-Debug.commands = $$build DemoProject Linux Debug  -project="\"$$gameProjectFile\"" $$args
DemoProject-Linux-DebugGame.commands = $$build DemoProject Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DemoProject-Linux-Shipping.commands = $$build DemoProject Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DemoProject-Linux-Test.commands = $$build DemoProject Linux Test  -project="\"$$gameProjectFile\"" $$args
DemoProject.commands = $$build DemoProject Linux Development  -project="\"$$gameProjectFile\"" $$args

DemoProjectEditor-Linux-Debug.commands = $$build DemoProjectEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
DemoProjectEditor-Linux-DebugGame.commands = $$build DemoProjectEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DemoProjectEditor-Linux-Shipping.commands = $$build DemoProjectEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DemoProjectEditor-Linux-Test.commands = $$build DemoProjectEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
DemoProjectEditor.commands = $$build DemoProjectEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
